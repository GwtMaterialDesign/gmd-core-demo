 ...
 * #L%
 */
package gmd.core.demo.client.application.page.fab;
...
public class FabPresenter extends AppPresenter<FabPresenter.MyView, FabPresenter.MyProxy> {
    interface MyView extends View {
    }

    @ProxyStandard
    @NameToken(NameTokens.FAB)
