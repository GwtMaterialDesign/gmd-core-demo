...
public class BreadcrumbPresenter extends AppPresenter<BreadcrumbPresenter.MyView, BreadcrumbPresenter.MyProxy> {
    interface MyView extends View {
    }

    @ProxyStandard
    @NameToken(NameTokens.BREADCRUMB)
    interface MyProxy extends ProxyPlace<BreadcrumbPresenter> {
    }
