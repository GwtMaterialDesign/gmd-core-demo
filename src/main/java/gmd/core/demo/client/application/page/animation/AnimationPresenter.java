...
public class AnimationPresenter extends AppPresenter<AnimationPresenter.MyView, AnimationPresenter.MyProxy> {
    interface MyView extends View {
    }

    @ProxyStandard
    @NameToken(NameTokens.ANIMATION)
    interface MyProxy extends ProxyPlace<AnimationPresenter> {
    }
